...
QUALITY_GATE_CASES = [
    ...
    {
        "id": "Q11",
        "question": "What is the core one-liner about JLR Reimagine growth from the screenshot?",
        "expected_top_source_type": "image",
        "must_include_source_types": ["image"],
        "must_contain": ["核心一句话总结", "Reimagine", "Growth"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q12",
        "question": "What risks and improvement priorities are mentioned about warranty cost and customer trust?",
        "expected_top_source_type": "image",
        "must_include_source_types": ["image"],
        "must_contain": ["warranty", "质量", "客户信任"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q13",
        "question": "What does the GEO report say about new energy vehicle brands?",
        "expected_top_source_type": "pdf",
        "must_include_source_types": ["pdf"],
        "must_contain": ["新能源汽车", "GEO", "品牌"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q14",
        "question": "What is Doubao vision pro 32k used for?",
        "expected_top_source_type": "pdf",
        "must_include_source_types": ["pdf"],
        "must_contain": ["doubao", "vision", "ArkLLMVisionUnderstanding"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q15",
        "question": "What are the EGO UMI VLA milestone stages?",
        "expected_top_source_type": "pdf",
        "must_include_source_types": ["pdf"],
        "must_contain": ["EVT", "DVT", "PVT"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q16",
        "question": "What is the detailed execution plan for the Xinjiang Ili valley and Duku highway trip?",
        "expected_top_source_type": "pdf",
        "must_include_source_types": ["pdf"],
        "must_contain": ["每日详细执行计划", "伊宁", "独库"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q17",
        "question": "What is the refractory plantar wart treatment plan?",
        "expected_top_source_type": "pptx",
        "must_include_source_types": ["pptx"],
        "must_contain": ["顽固性跖疣", "22 次液氮", "病损内注射"],
        "source_status": "grounded",
        "sources_empty": False,
    },
    {
        "id": "Q18",
        "question": "What is VIGOUR CARE CLINIC cell cleanup about?",
        "expected_top_source_type": "pptx",
        "must_include_source_types": ["pptx"],
        "must_contain": ["VIGOUR CARE", "细胞大扫除", "自由基"],
        "source_status": "grounded",
        "sources_empty": False,
    },
]
